...
/* A small, dependency-free set of line icons used across the homepage. */
...
export function PillarIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden {...props}>
      <path d="M12 2 2 7v1h20V7L12 2Zm-7 8v7H4v2h16v-2h-1v-7h-2v7h-3v-7h-2v7H8v-7H5Z" />
    </svg>
  );
}
